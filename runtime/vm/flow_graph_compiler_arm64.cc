...
// This function must be in sync with `segv_continuation_arm64.S`!
//
...
void FlowGraphCompiler::RecordSignalContinuationSafepoint(
  ...
  PushRegisterToStackmap(bitmap, registers, R25);
  PushRegisterToStackmap(bitmap, registers, R24);
  PushRegisterToStackmap(bitmap, registers, R23);
  PushRegisterToStackmap(bitmap, registers, R22);
  PushRegisterToStackmap(bitmap, registers, R21);
  PushRegisterToStackmap(bitmap, registers, R20);
  PushRegisterToStackmap(bitmap, registers, R19);
